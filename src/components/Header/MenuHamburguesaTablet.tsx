...
import styles from './MenuHamburguesaTablet.module.css'

export type MenuHamburguesaTabletType = {
  className?: string
  onClose?: () => void
}
...
const MenuHamburguesaTablet: FunctionComponent<MenuHamburguesaTabletType> = ({
  className = '',
  onClose,
}) => {
  return (
...
export default MenuHamburguesaTablet
